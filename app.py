...
class JsonHandler:
    def __init__(self, filename: Optional[str] = None) -> None:
        if filename is None:
            ...
            filename = f"eod_data_{today}.json"
...
class EODTracker:
    def __init__(self, test_mode: bool = False) -> None:
        if test_mode:
            ...
            self.js_handler = JsonHandler("eod_json/test_data.json")
        else:
    ...
    blocker report
    '''
    def start_blocker(self, description: str) -> bool:
        if self.js_handler.data.get("current_blocker"):
        ...
        print(f"Started blocker: '{description}' at {current_blocker['start_time']}")
